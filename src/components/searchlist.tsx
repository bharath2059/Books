    ...
    return(
        <SafeAreaView style = {styles.wrapper}>
            ...
            <View style = {styles.box1}>
                <Text style = {styles.headingstyle}>Study coding</Text>   
            </View>
            <View style = {styles.box2}>
                <View style = {styles.ListStyle}>
                    <Image source = {require('./../Assets/1.jpg')} style = {styles.imageStyle}/>
                    <Text style = {styles.listTextStyle}>Title : Coding Projects in Python</Text>
                    <Text style = {styles.listTextStyle}>Description : you'll learn how to build amazing graphics, fun games, and useful apps using Python</Text>
                ...
                <Image source = {require('./../Assets/2.jpg')} style = {styles.imageStyle}/>
                    ...
                    <Text style = {styles.listTextStyle}>Description : THE BEST SQL BOOK FOR BEGINNERS</Text>
                    <Text style = {styles.listTextStyle}>Price : 30 CAD</Text> 
                </View>
                <View style = {styles.ListStyle}>
                <Image source = {require('./../Assets/3.jpg')} style = {styles.imageStyle}/>
                    <Text style = {styles.listTextStyle}>Title : Hello World!</Text>
                    <Text style = {styles.listTextStyle}>Description : Computer programming is a powerful tool for children</Text>
                    <Text style = {styles.listTextStyle}>Price : 20 CAD</Text> 
                </View>
                <View style = {styles.ListStyle}>
                <Image source = {require('./../Assets/4.jpg')} style = {styles.imageStyle}/>
